...
struct xSSSFunction : public Function<xSSSFunction> {
    ...
    static at::Tensor forward(AutogradContext *ctx, const at::Tensor& x, const at::Tensor& a) {
        ...
        static auto op = torch::Dispatcher::singleton()
            .findSchemaOrThrow("xsss::forward", "")
            .typed<decltype(xsss_forward_cuda)>();
    ...
    static tensor_list backward(AutogradContext *ctx, tensor_list grad_outputs) {
        ...
        static auto op = torch::Dispatcher::singleton()
            .findSchemaOrThrow("xsss::backward", "")
            .typed<decltype(xsss_backward_cuda)>();
...
TORCH_LIBRARY_IMPL(xsss, CUDA, m) {
    m.impl("forward", xsss_forward_cuda);
    m.impl("backward", xsss_backward_cuda);
}

// AUTOGRAD implementation (found via dispatcher if autograd is enabled)
TORCH_LIBRARY_IMPL(xsss, Autograd, m) {
    m.impl("forward", xsss_forward_autograd);
...
/*
TORCH_LIBRARY_IMPL(xsss, CPU, m) {
    m.impl("forward", xsss_forward_cpu);
}
*/
