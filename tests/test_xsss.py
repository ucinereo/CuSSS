...
def test_backward(xsss_setup):
    ...
    torch.testing.assert_close(x_grad_cuda, grad_x_ref, rtol=1e-5, atol=1e-5)
    torch.testing.assert_close(a_grad_cuda, grad_a_ref, rtol=1e-5, atol=1e-5)